...
public class GerenciadorEstoque
{
    ...
    public GerenciadorEstoque(int Id, string Nome)
    {
        ...
        {
            new Produto_Eletronico("Celular", 1590, 300, "asdhb7r934ur7", "Bivolt", true),
             new Produto_Eletronico("Dell G15", 5000, 2435, "NOTE32d723", "Bivolt", true),
            new Produto_Vestuario("Camisa Brasil", 129.90, 10000, "CAMBR0001", "Camisa 1", "Azul", "P")
        };
    }
    ...
    public void BuscarProdutoPorNome()
    {
        try
        {
            ...
            Produto produtoBuscado = produtos.Find(
                produto => produto.nome.Equals(nomeProduto, StringComparison.OrdinalIgnoreCase)
            );
    ...
    private Produto coletaDados(int tipoProduto)
    {
        try
        {
            ...
            if (tipoProduto == 1)
            {
                ...
                Produto_Eletronico novoEletronico = new Produto_Eletronico(nome, preco, quantidade, sku, voltagem, bateria);
            ...
            else
            {
                ...
                Produto_Vestuario novoVestuario = new Produto_Vestuario(nome, preco, quantidade, sku, modelo, cor, tamanho);
