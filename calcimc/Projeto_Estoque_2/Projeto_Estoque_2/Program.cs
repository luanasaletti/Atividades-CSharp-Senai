...
Produto_Vestuario camisaNike = new Produto_Vestuario("Camisa da Nike", 199.99, 100, "8234ASDJGIFU3", "esportivo", "Branca", "G");

Produto_Eletronico notebookDellG15 = new Produto_Eletronico("Dell G15", 3500.00, 50, "ASDJH384FDD", "110V", true);
